...
@section('subtitle', 'Define a new service that residents can request through the portal')
    ...
    <form action="{{ route('admin.services.store') }}" method="POST" class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="classification" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent" required>
                                    @foreach($classifications as $classification)
                                        <option value="{{ $classification }}" {{ old('classification') == $classification ? 'selected' : '' }}>{{ $classification }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="who_may_avail" value="{{ old('who_may_avail') }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent"
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="fee" value="{{ old('fee', 0) }}" step="0.01" min="0"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent"
                                       placeholder="0.00">
                            ...
                            <div>
                                ...
                                <input type="text" name="fee_description" value="{{ old('fee_description') }}"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input type="number" name="processing_time_minutes" value="{{ old('processing_time_minutes') }}" min="0"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green focus:border-transparent"
                    ...
                    <div id="requirementsContainer" class="space-y-3">
                        <div class="requirement-item flex gap-3 items-start">
                            <div class="flex-1 grid grid-cols-12 gap-3">
                                <input type="text" name="requirements[0][requirement]" class="col-span-6 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green" placeholder="e.g., Valid Government ID">
                                <input type="text" name="requirements[0][where_to_secure]" class="col-span-5 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sea-green" placeholder="e.g., PhilSys, Driver's License, Passport">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div id="stepsContainer" class="space-y-3">
                        <div class="step-item border border-gray-200 rounded-lg p-4">
                            ...
                            <input type="text" name="steps[0][title]" class="w-full px-4 py-2 border border-gray-300 rounded-lg mb-2" placeholder="Step title">
                            <textarea name="steps[0][description]" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg mb-2" placeholder="Step description"></textarea>
                            <div class="grid grid-cols-2 gap-3">
                                <input type="text" name="steps[0][assigned_office]" class="px-4 py-2 border border-gray-300 rounded-lg" placeholder="Assigned office">
                                <input type="number" name="steps[0][duration_minutes]" class="px-4 py-2 border border-gray-300 rounded-lg" placeholder="Duration (min)">
                            </div>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6 sticky top-8">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="icon" value="{{ old('icon', '📄') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-center text-2xl" placeholder="📄">
                        </div>
                        <div>
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            <label class="flex items-center gap-3">
                                <input type="checkbox" name="is_active" value="1" checked class="w-5 h-5 rounded text-sea-green">
                ...
                <div class="space-y-3">
                    <button type="submit" class="w-full bg-sea-green hover:bg-deep-forest text-white px-6 py-3 rounded-lg font-bold transition shadow-sm">💾 Create Service</button>
                    <a href="{{ route('admin.services.index') }}" class="block w-full bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-3 rounded-lg font-bold transition text-center">Cancel</a>
                </div>
            </div>
